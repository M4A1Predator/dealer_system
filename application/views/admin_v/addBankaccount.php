                    ...
                    <div class="row">
                        <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                              ...
                              <form id="productForm" action="<?=base_url()?>admin/bank/add_new_bank" method="POST" data-parsley-validate="" required class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" value="" name="accountNum" required="required" class="form-control col-md-7 col-xs-12" data-parsley-id="1135">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" value="" name="accountName" required="required" class="form-control col-md-7 col-xs-12" data-parsley-id="1135">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" value="" name="branch" class="form-control col-md-7 col-xs-12" data-parsley-id="1135">
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="col-sm-3 col-sm-offset-2">
                                        ...
                                        <input type="submit" onclick="" class="btn btn-success" value="เพิ่มบัญชี">
                                    </div>
                                </div>
                            </form>
