        ...
        <!-- custom JQ JS -->
        <script src="<?=base_url()?>assets/angjq/alertJq.js" type="text/javascript"></script>
        ...
        <!-- flot js -->
        <!--[if lte IE 8]><script type="text/javascript" src="<?=base_url()?>assets/js/excanvas.min.js"></script><![endif]-->
