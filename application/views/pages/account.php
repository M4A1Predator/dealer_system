                    ...
                    <div class="row margin-bottom-10">
                        <div class="col-sm-6 sm-margin-bottom-20">
                            <div class="service-block-v3 service-block-u">
                                ...
                                <span class="service-heading">ยอดสั่งซื้อสินค้ารวม</span>
                                <span class="counter"><?=display_amount($all_amount)?> ชิ้น</span>

                                <div class="clearfix margin-bottom-10"></div>

                                <div class="row margin-bottom-20">
                                    <div class="col-xs-6 service-in">
                                        <small>เดือนก่อนหน้า</small>
                                        <h4 class="counter"><?=display_amount($previous_amount)?> ชิ้น</h4>
                                    </div>
                                    <div class="col-xs-6 text-right service-in">
                                        <small>เดือนนี้</small>
                                        <h4 class="counter"><?=display_amount($now_amount)?> ชิ้น</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="service-block-v3 service-block-blue">
                                ...
                                <span class="service-heading">ยอดใช้จ่ายรวม</span>
                                <span class="counter"><?=display_money($all_spent)?> บาท</span>

                                <div class="clearfix margin-bottom-10"></div>

                                <div class="row margin-bottom-20">
                                    <div class="col-xs-6 service-in">
                                        <small>ยอดใช้จ่ายเดือนนี้</small>
                                        <h4 class="counter"><?=display_money($now_spent)?> บาท</h4>
                                    </div>
                                    <div class="col-xs-6 text-right service-in">
                                        <small>ประมาณกำไร</small>
                                        <h4 class="counter"><?=display_money($benefit)?> บาท</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-width"><?=$order->order_datetime?></td>
